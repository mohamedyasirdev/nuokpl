            ...
            <motion.div className='flex md:pl-7 space-x-3 md:space-x-10'>
                ...
                <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} transition={{ delay: 0.6, type: 'tween' }} className='md:w-10/12 mb-24'>
                    ...
                    <h3 className="text-[28px] md:text-[40px] max-md:leading-8 max-lg:leading-10 lg:text-5xl mb-7 font-medium text-white js-build-in-item build-in-slideX-left build-in-animate" style={{ transitionDelay: '300ms' }}>
                        ...
                        With NovaPlus, developers can secure their code in minutes and organizations can automatically comply with regulations.
                    </h3>
                </motion.div>
            </motion.div>
                    ...
                    <div className='overflow-auto md:flex flex-col md:space-y-20 flex-1 py-20 md:p-10 p-5 my-6    justify-between md:min-w-[400px]'>
                        ...
                        <div>
                            <a onMouseEnter={() => setHovered(true)} onMouseLeave={() => setHovered(false)} href="https://www.facebook.com/mohamedyasser1070" className='py-1 inline-block text-xl text-white font-semibold'>
                                Invest With NovaPlus & Gunt Sponsers
            ...
            <div className='flex flex-col md:flex-row gap-10 '>
                <HoverCard backgroundColor='#939aff' direction='flex-col' left='0'>
                    <div className='md:flex flex-col flex-1 p-8 sm:p-10 lg:py-16 lg:pl-16 lg:pr-32'>
                        ...
                        <div>
                            <a onMouseEnter={() => setHovered1(true)} onMouseLeave={() => setHovered1(false)} href="https://www.facebook.com/mohamedyasser1070" className='py-1 inline-block text-xl text-white font-semibold'>
                                Explore Dependabot
                ...
                <HoverCard backgroundColor='#939aff' direction='flex-col' left='-400px'>
                    <div className='md:flex flex-col  flex-1 p-8 sm:p-10 lg:py-16 lg:pl-16 lg:pr-32 '>
                        <p className=" text-xl md:text-2xl mb-6 font-medium text-[#7d8590]"><span className='text-white font-semibold'>Code scanning</span>is NovaPlus’s static code analysis tool that helps you remediate issues in your code.</p>
                        <div>
                            <a onMouseEnter={() => setHovered2(true)} onMouseLeave={() => setHovered2(false)} href="https://www.facebook.com/mohamedyasser1070" className='py-1 inline-block text-xl text-white font-semibold'>
