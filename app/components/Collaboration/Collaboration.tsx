      ...
      <div className='flex md:pl-7 space-x-3 md:space-x-10'>
            ...
            <div className='flex justify-between md:space-x-10 max-md:flex-col'>
                <HoverCard backgroundColor='#ffa28b' direction='flex-col' left='0'>
                    <div className='md:flex flex-col flex-1 p-8 sm:p-10 lg:py-16 lg:pl-16 lg:pr-32 '>
                        <p className=" text-xl md:text-2xl mb-6 font-medium text-[#7d8590]"><span className='text-white font-semibold'>Nova+ Actions</span>  automates your build, test, and deployment workflow with simple and secure CI/CD.</p>
                        <div>
                        <a onMouseEnter={() => setHovered(true)} onMouseLeave={() => setHovered(false)} href="https://www.facebook.com/mohamedyasser1070" className='py-1 inline-block text-xl text-white font-semibold'>
                            Enable Nova+ Discussion
                ...
                <HoverCard backgroundColor='#ffa28b' direction='flex-col' left='-400px'>
                    <div className='md:flex flex-col  flex-1 p-8 sm:p-10 lg:py-16 lg:pl-16 lg:pr-32 '>
                        <p className=" text-xl md:text-2xl mb-6 font-medium text-[#7d8590]"><span className='text-white font-semibold'>Nova+ Mobile</span>   fits your projects in your pocket, so you never miss a beat while on the go.</p>
                        <div>
                            <a onMouseEnter={() => setHovered1(true)} onMouseLeave={() => setHovered1(false)} href="https://web.facebook.com/mohamedyasser1070" className='py-1 inline-block text-xl text-white font-semibold'>
        ...
        <HoverCard backgroundColor='#ffa28b' direction='' left=''>
          <div className='md:flex flex-col md:space-y-20 flex-1 py-20 p-10  justify-between'>
              <p className=" text-xl md:text-2xl mb-6 font-medium text-[#7d8590]"><span className='text-white font-medium'>NovaPlus Sponsors</span>  lets you support your favorite open source maintainers and projects.</p>
              <div>
          ...
          <div className='overflow-hidden rounded-s-lg z-[1] flex-1'>
              <motion.div variants={container} initial='hidden' whileInView='show'  className='flex flex-wrap w-full relative -top-[120px] -rotate-12 -right-6 -mt-6  p-6 max-h-[480px]'>
                  <motion.div variants={item} transition={{type:'tween'}} className='w-1/3 '>
                      <a href="https://www.facebook.com/mohamedyasser1070" target='_blank' className='rounded-md bg-[#161b22] border-[0.5px] border-[#30363d] flex flex-col items-center m-2 p-6'>
                  ...
                  <motion.div variants={item} transition={{type:'tween'}} className='w-1/3 '>
                      <a href="https://web.facebook.com/mohamedyasser1070" target='_blank' className='rounded-md bg-[#161b22] border-[0.5px] border-[#30363d] flex flex-col items-center m-2 p-6'>
