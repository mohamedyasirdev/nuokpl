...
const HoverCard = ({ children, backgroundColor, direction, left }: Props) => {
    ...
    return (
        <animated.div onMouseMove={handleMouseMove} onMouseLeave={handleMouseLeave} style={{ transform: springProps.xys.to(trans) }} className="overflow-hidden  mb-3 md:mb-8 rounded-xl">
