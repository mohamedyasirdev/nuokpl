                ...
                <div className='flex justify-between md:space-x-10 max-md:flex-col'>
                    <HoverCard backgroundColor='#7ee787' direction='flex-col' left='0'>
                        <div className='md:flex flex-col flex-1 p-8 sm:p-10 lg:py-16 lg:pl-16 lg:pr-32 '>
                            ...
                            <div>
                                <a onMouseEnter={() => setHovered(true)} onMouseLeave={() => setHovered(false)} href="https://www.facebook.com/mohamedyasser1070" className=' md:text-xl text-white font-semibold inline-block' target='_blank'>
                                    Discover Nova+ Actions
                    ...
                    <HoverCard backgroundColor='#7ee787' direction='flex-col' left='-400px'>
                        <div className='md:flex flex-col  flex-1 p-8 sm:p-10 lg:py-16 lg:pl-16 lg:pr-32 '>
                            ...
                            <div>
                                <a onMouseEnter={() => setHovered1(true)} onMouseLeave={() => setHovered1(false)} href="https://www.facebook.com/mohamedyasser1070" className=' md:text-xl text-white font-semibold inline-block' target='_blank'>
                                    Get Mobile App
