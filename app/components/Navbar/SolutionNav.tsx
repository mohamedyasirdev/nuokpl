            ...
            <div className={`relative lg:absolute -ml-5 bg-white rounded-md lg:py-4 p-6 w-[300px] transition ease-in duration-300 ${show ? "opacity-100 " : "opacity-0 hidden top-[2000px]"}`}>
                <div className='lg:border-b-[1px] mb-4 pb-4 pt-4 w-full'>
                    ...
                    <ul className='text-sm text-neutral-500 mt-1 w-full'>
                        ...
                        <li >
                            <a href="https://www.facebook.com/mohamedyasser1070" className='block py-2 hover:text-blue-600' target='_blank'>Enterprise</a>
                        </li>

                        <li>
                            <a href="https://www.facebook.com/mohamedyasser1070" className='block py-2 hover:text-blue-600' target='_blank'>Teams</a>
                        </li>

                        <li >
                            <a href="https://www.facebook.com/mohamedyasser1070" className='block py-2 hover:text-blue-600' target='_blank'>Startups</a>
                        </li>
                ...
                <div className='lg:border-b-[1px] mb-4 pb-4 pt-2 w-full'>
                    ...
                    <ul className='text-sm text-neutral-500 mt-1 w-full'>
                        ...
                        <li className='py-2'>
                            <Navlist2 main='Nova+ Product' path='M3.75 2h3.5a.75.75 0 0 1 0 1.5h-3.5a.25.25 0 0 0-.25.25v8.5c0 .138.112.25.25.25h8.5a.25.25 0 0 0 .25-.25v-3.5a.75.75 0 0 1 1.5 0v3.5A1.75 1.75 0 0 1 12.25 14h-8.5A1.75 1.75 0 0 1 2 12.25v-8.5C2 2.784 2.784 2 3.75 2Zm6.854-1h4.146a.25.25 0 0 1 .25.25v4.146a.25.25 0 0 1-.427.177L13.03 4.03 9.28 7.78a.751.751 0 0 1-1.042-.018.751.751 0 0 1-.018-1.042l3.75-3.75-1.543-1.543A.25.25 0 0 1 10.604 1Z' />
                        </li>
